export const es = {
  ...
  account: {
    ...
    errors: {
      ...
      cannotDeleteOnlyAddress: "No se puede eliminar la única dirección",
      cannotDeleteDefaultAddress: "No se puede eliminar la dirección predeterminada"
    }
  },
  newsletter: {
  ...
  orders: {
    ...
    orderAddress: "Dirección de envío",
    pending: "Pendiente",
